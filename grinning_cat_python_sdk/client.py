from grinning_cat_python_sdk.clients import HttpClient, WSClient
from grinning_cat_python_sdk.configuration import Configuration
from grinning_cat_python_sdk.endpoints import (
    AdminsEndpoint,
    AuthEndpoint,
    AuthHandlerEndpoint,
    ChunkerEndpoint,
...
class GrinningCatClient:
    ...
    def add_token(self, token: str) -> 'GrinningCatClient':
